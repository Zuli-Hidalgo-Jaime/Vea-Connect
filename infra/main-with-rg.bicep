...
// Variables
var resourceGroupName = '${projectName}-resource-group'
...
var storageAccountName = '${projectName}storage${uniqueString(subscription().id)}'
...
// 6. Virtual Machine para Redis Stack
