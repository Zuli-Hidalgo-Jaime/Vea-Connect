"""
Demostración del harness de testing - Script independiente.

Este script demuestra el uso del harness sin dependencias de imports relativos.
"""
...
# Importar mocks directamente
from mock_openai import create_mock_openai_client
